...
it('parses the server shapes', () => {
  ...
  WorkProjects.parse({ projects: [{ id: 1, display_name: 'p', root: '/r', present: true, last_error: null, active_ms_30d: 1, commits_30d: 1, daily_active_ms: [0, 1], last_worked_at: null }] });
  WorkOverview.parse({
    tiles: { active_ms: 1, cost: 1, commits: 1, cost_per_commit: null }, prior: { active_ms: 0, cost: 0, commits: 0, cost_per_commit: null },
    daily: { days: ['2026-09-01'], active_ms: [1], commits: [0] },
    stories: [{ title: 't', branch: null, prs: [], sessions: 1, session_ids: ['a'], active_ms: 1, cost: 1, first_ts: 'x', last_ts: 'y',
